 ...
 * Time： 19:20
 */
public class TestInitResCustInfo extends BaseUtest {
    ...
    public void TestInsert() throws Exception {
        ...
        for (ResCustInfoBean item : list) {
            ...
            item.setCompany("浙江科技有限公司" + i);
            item.setCompanyAddr("杭州西湖区");
            item.setTelphone(getNumber());
            item.setInputDate(new Date());
            item.setMobilephone(getNumber());
            item.setEmail("test@163.com");
            Date randomDate = randomDate("2015-01-20", "2016-01-28");
            item.setOwnerStartDate(randomDate);
            item.setName(getName());
            //System.out.println(getName());
            resCustInfoMapper.update(item);
          /*  try {
                Thread.sleep(20);
...
//如果返回的是开始时间和结束时间，则递归调用本函数查找随机值
    ...
    public String getCpName(){
       String str="";
        str+="万科 中国海外中海） 保利 绿地 恒大 绿城 合生创展 富力 金地 首都开发首开）龙湖 远洋 大华 中信地产 首创置业 招商局 北辰实业 珠江 金科 SOHO 金融街 复地 阳光100 苏宁环球 农工商 融侨集团 金隅嘉业 合景泰富 佳兆业 杭州滨江 蓝光和骏 深业集团 金都 鑫苑 沿海绿色家园 天津市房地产开发(天津房开) 宝龙 星惠誉 上海城开 浙江广厦 海尔 重庆隆鑫 方圆地产 协信 三盛宏业 禹洲 武汉地产开发投资(武开) 花样年 福建正荣 上海爱家豪庭 栖霞建设 深圳富通 上海中房置业 永泰 百步亭 深圳香江控股 正商置业 旭辉集团 浙江昆仑置业 广州颐和 武汉三江航天 上海上投房地产 浙江佳源 云南俊发 广西东方航洋 天津塘沽贻成实业 海亮地产 重庆光华控股 上海三湘股份 广州市海伦堡 青岛伟东置业 奥宸地产 联发集团 天津津滨发展 杭州都房地产 广东利海 深圳合正 广州百嘉信 力高 上海中锐 中骏置业 众安 大发集团 重庆长安 宁波奥克斯 莱蒙鹏源 重庆市兴茂 浙江祥生 江西恒茂 上海凯迪 莱茵达置业 福建华辰 华润置地 世茂 碧桂园 万达 雅居乐 世纪金源 星河湾 瑞安 中华企业 越秀城建 新湖中宝 上置集团 江苏新城 方兴地产 凯德置地 万通 中铁置业 鸿荣源 陆家嘴 卓越置业 珠海华发 融科智地 上海中星 泛海建设 亿达 浙江省商业集团（浙商集团） 厦门建发 新世界 建业 河北卓达 雅戈尔 上海实业（上实） 天津市房地产（天房） 金隅股份 荣盛  北京城建 恒盛 上海城投置地 上海建工 上海宝华企业集团 青岛海信 北京住总 安徽元一集团 宁波银亿 中粮地产 上海证大 亿城集团 奥园地产 天津泰达 华侨城";
        String[] list = str.split(" ");
        return list[RoundUtil.getRandom(0, list.length - 1)];
    }
