...
public class TestCreateTableSql {
    ...
    public static void main(String[] args) throws SQLException {
        ...
        String sql = "";
        sql = createTablePartition(str, "org_id", 200);
        sql = createTableBroadcasts(str);
     ...
     * @throws SQLException
     */
    public static String createTablePartition(String sql, String column, int len) throws SQLException {
        //   Assert.isNull(sql);
     ...
     * @throws SQLException
     */
    public static String createTableBroadcasts(String sql) throws SQLException {
        StringBuffer buff = new StringBuffer();
        if (sql.endsWith(";")) {
            sql = sql.replaceAll(";", "");
        }
