...
import com.qftx.tsm.credit.dao.ImportLeadFileMapper;
...
@Service
public class ImportLeadFileService {
	@Autowired 
	ImportLeadFileMapper mapper;
	@Autowired
	ImportLeadInfoService importResInfoService;
	@Autowired
	ResourceGroupMapper resGroupMapper;
	@Autowired
    private SysFileService sysFileService;
	@Autowired private CachedService cachedService;
	@Autowired private ImportLeadInfoService resInfoService;
	@Autowired private ImportLeadResultService importResResultService;
	Logger logger = Logger.getLogger(ImportLeadFileService.class);
	
	/* 查询*/
	public ImportLeadFileBean queryById(String orgId,String id){
		ImportLeadFileBean entity = new ImportLeadFileBean();
	...
	public  boolean excel2Db(String orgId,String id,List<String>fields,String firstCheckVal){
		boolean flag=false;
		ImportLeadFileBean bean = queryById(orgId, id);
	...
	/* 插入*/
	public ImportLeadFileBean insert(String orgId,String groupId,String resGroupId,Integer resStatus,String userId,String fileId,Date date){
		ImportLeadFileBean bean = new ImportLeadFileBean();
