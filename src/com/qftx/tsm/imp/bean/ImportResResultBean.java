...
/* import_res_result 资源导入_分析结果*/
public class ImportResResultBean extends BaseObject {
	...
	private Integer custNameRepeat;	//客户名称重复
	private Integer phoneSpace;	//电话号码空号
	private Integer phoneStop;	//电话号码停机
	private Integer companyUrlRepeat;	//公司网址重复
	private Integer phoneNeverAnswer;	//电话从不接听
	private Integer callTimeAverageShort;	//平均通话时长不足10秒
	...
	public Integer getCustNameRepeat() {
		return custNameRepeat;
	}
	public void setCustNameRepeat(Integer custNameRepeat) {
		this.custNameRepeat = custNameRepeat;
	}
	public Integer getPhoneSpace() {
		return phoneSpace;
	}
	public void setPhoneSpace(Integer phoneSpace) {
		this.phoneSpace = phoneSpace;
	}
	public Integer getPhoneStop() {
		return phoneStop;
	}
	public void setPhoneStop(Integer phoneStop) {
		this.phoneStop = phoneStop;
	}
	public Integer getCompanyUrlRepeat() {
		return companyUrlRepeat;
	}
	public void setCompanyUrlRepeat(Integer companyUrlRepeat) {
		this.companyUrlRepeat = companyUrlRepeat;
	}
	public Integer getPhoneNeverAnswer() {
		return phoneNeverAnswer;
	}
	public void setPhoneNeverAnswer(Integer phoneNeverAnswer) {
		this.phoneNeverAnswer = phoneNeverAnswer;
	}
	public Integer getCallTimeAverageShort() {
		return callTimeAverageShort;
	}
	public void setCallTimeAverageShort(Integer callTimeAverageShort) {
		this.callTimeAverageShort = callTimeAverageShort;
	}
