 ...
 * @history:
 */
public class LogCommuOptorBean extends BaseObject{
    ...
    private BigDecimal operateTimelength;    //操作时长
    ...
    private Long afterOperateTimelength;	 //剩余时长
    ...
    public BigDecimal getOperateTimelength() {
        return operateTimelength;
    }

    public void setOperateTimelength(BigDecimal operateTimelength) {
	...
	public Long getAfterOperateTimelength() {
		return afterOperateTimelength;
	}

	public void setAfterOperateTimelength(Long afterOperateTimelength) {
