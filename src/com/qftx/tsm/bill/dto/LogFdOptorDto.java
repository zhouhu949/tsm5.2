...
public class LogFdOptorDto extends LogFdOptorBean {
	private static final long serialVersionUID = -5656663936826095960L;
     ...
     private Double firstOperateTimelength;		//操作前剩余时长
	...
	public Double getFirstOperateTimelength() {
		return firstOperateTimelength;
	}

	public void setFirstOperateTimelength(Double firstOperateTimelength) {
