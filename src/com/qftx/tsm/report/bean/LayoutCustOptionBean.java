...
public class LayoutCustOptionBean extends BaseObject {
	private static final long serialVersionUID = 6421632707695857445L;
	
	private String id;//id
	private String orgId;//单位ID
	private String groupId;//分组ID
	private String groupName;//分組名名称
	private String userAccount;//帐号
	private String userName;//姓名
	private Integer type;//类型： 1-销售进程，2-客户类型
	private String optionlistId;//optionlist_id
