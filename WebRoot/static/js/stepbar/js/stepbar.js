...
var stepBar = {
    ...
    layout : function(){
        ...
        this.bar.find(".ui-stepInfo .ui-stepSequence01").addClass("judge-stepSequence-hind");
        this.bar.find(".ui-stepInfo:first-child .ui-stepSequence").addClass("judge-stepSequence-pre");
        this.bar.find(".ui-stepInfo:first-child .ui-stepSequence01").addClass("judge-stepSequence-pre");
    },
    classHover : function(){
        if(this.change){
    ...
    jump : function(){
        ...
        this.bar.find(".ui-stepInfo .ui-stepSequence01").removeClass("judge-stepSequence-pre").addClass("judge-stepSequence-hind");
        ...
        this.bar.find(".ui-stepInfo:nth-child(-n+" + this.triggerStep + ") .ui-stepSequence01").removeClass("judge-stepSequence-hind").addClass("judge-stepSequence-pre");
        this.classHover();
    },
    _animate : function(){
        ...
        this.bar.find(".ui-stepInfo:nth-child(" + this.curStep + ") .ui-stepSequence01").removeClass(preClass).addClass(hindClass);
        this.bar.find(".ui-stepInfo:nth-child(" + this.curStep + ") .ui-stepSequence01").animate(stepSequence_size, 500, easing);
        this.classHover();
    }
};