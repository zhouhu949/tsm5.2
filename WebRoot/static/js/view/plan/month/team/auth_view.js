...
function authPass(){
	$.post(ctx+"/plan/month/team/auth",{"planIdsStr":checkBox.ids.toString(),"authState":2,"context":null},
			function(data){
...
function authNoPass(){
	$.post(ctx+"/plan/month/team/auth",{"planIdsStr":checkBox.ids.toString(),"authState":0,"context":null},
			function(data){
		if("success"==data.status){
			refreshPage();
		}else{
