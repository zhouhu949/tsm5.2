...
_bb.find(".editBtn").show().end().find(".deleteBtn").show();
...
_bc.find(".editBtn").hide().end().find(".deleteBtn").hide();
if(tt.hasClass("tree-hit")){
if(tt.hasClass("tree-expanded")){
...
$("<span class=\"tree-title\" title=\""+item.text+"\"></span>").html(opts.formatter.call(_ff,item)).appendTo(node);
if(opts.checkbox){
