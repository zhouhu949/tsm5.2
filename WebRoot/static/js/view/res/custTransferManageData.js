...
function loaderAjax(_param,pageStr){
	...
	var _url = ctx+'/res/cust/custTransferManageData';
	searchingDataTip();
	...
	for(var i = 0;i<data.list.length;i++){
		...
		html+=
			"<tr id='rightView_"+AjaxQueryData.emptyTransfer(res.resCustId)+"' class='"+(i%2==0?'':'sty-bgcolor-b')+"'>" +
				"<td style='width:30px;'><div class='overflow_hidden w30 skin-minimal'><input type='checkbox' name='check_' ownerAcc='"+AjaxQueryData.emptyTransfer(res.ownerAcc)+"' custType='"+AjaxQueryData.emptyTransfer(res.custType)+"' id='chk_"+AjaxQueryData.emptyTransfer(res.resCustId)+"' /></div></td>" +
				...
				"<td><div class='overflow_hidden w80' title='"+AjaxQueryData.emptyTransfer(res.ownerName )+"'>"+AjaxQueryData.emptyTransfer(res.ownerName )+"</div></td>" +
				...
				"<td><div class='overflow_hidden w80' title='"+AjaxQueryData.emptyTransfer(res.area )+"'>"+AjaxQueryData.emptyTransfer(res.area )+"</div></td>" +
				"<td><div class='overflow_hidden w80' title='"+AjaxQueryData.emptyTransfer(res.companyTrade )+"'>"+AjaxQueryData.emptyTransfer(res.companyTrade )+"</div></td>" +
