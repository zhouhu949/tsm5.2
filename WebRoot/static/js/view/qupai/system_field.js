...
//			console.log(data_entitys);
	...
	$(".ajax-table>tbody").delegate(".fa-edit","click",function(e){
		...
		pubDivShowIframe('alert_sys_field_set',url+'?id='+id+'&v='+new Date().getTime(),'编辑字段',500,360);
	});
	...
	$('.demoBtn_a').click(function(){
    	...
    	$.ajax({
			...
			success : function(data) {
				if(data <  data_count){
					pubDivShowIframe('alert_sys_field_set',data_url+'?v='+new Date().getTime(),'新增字段',500,360);
				}else{
