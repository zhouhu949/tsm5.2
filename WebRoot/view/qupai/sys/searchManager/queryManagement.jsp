...
<div class="hyx-sfs com-table-a hyx-mpe-table hyx-cm-table fl_l" style="overflow-x:hidden;">
	<div class="year-sale-play">
		<ul class="ann-sale-plan clearfix">
			...
			<a href="${ctx }/workflowSet/toWorkflowSetPage.do"><li class="">工作流程设置</li></a>
			<a href="${ctx }/quPaiSearchManager/searchSetPage"><li class="select li_last">查询项管理</li></a>
		</ul>
	</div>
	...
	<div class="hyx-sfs fl_l" style="overflow-x:hidden;">
		...
		<p class="hyx-mpe-p" style="margin-left:1%;">
			...
			<select style="width: 200px; height: 22px;" class="search-modules">
				<c:forEach items="<%=SysEnum.getQupaiSearchModules()%>" var="searchModule">
...
{{#each list}}
	<tr class="{{even_odd @index}}">
		...
		<td>{{searchName}}</td>
		<td>{{qupaiManageJudgeDataType dataType}}</td>
...
<!--本页面js-->
<script type="text/javascript" src="${ctx}/static/js/view/qupai/query_management.js"></script>
