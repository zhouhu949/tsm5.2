...
<body>
	<form id="cform" class="clearfix" action="${ctx }/pakage/allocation/memberPakageList" method="post">
...
<!-- 						<a class="com-btna demoBtn_c fl_l" id="smsRechargeId" href="javascript:;"><i class="min-reass"></i><label class="lab-mar">短信分配</label></a>
						<a class="com-btna demoBtn_d fl_l" id="smsRecoverId" href="javascript:;"><i class="min-back"></i><label class="lab-mar">短信回收</label></a> -->
			</div>
			<p class="com-moTag skin-minimal com-mta fl_l" style="width: 100%;" ><label class="f">当前单位剩余可分配通信币：<span class="font-color">${totalTimes }</span><span class="product-currencyUnit">蜂豆</span>（1元兑换100<span class="product-currencyUnit">蜂豆</span>）</label></p>
