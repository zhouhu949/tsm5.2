...
<body>
    <form id="cform" action="${ctx }/pakage/allocation/findLogFdOptorList" method="post">
        <div class="hyx-ctr">
           <div class="com-search hyx-cfu-search">
              <div class="com-search-box fl_l">
               ...
               <div class="list-box">
                   ...
                   <c:choose>
                        <c:when test="${optorDto.operateType eq 1 }"><c:set var="osName" value="通信分配" /></c:when>
                        <c:when test="${optorDto.operateType eq 2 }"><c:set var="osName" value="通信回收" /></c:when>
                   ...
                   <dl class="select">
                        ...
                        <dd>
                            <ul>
                                ...
                                <li><a href="javascript:;" onclick="$('#operateType').val('1')" title="通信分配">通信分配</a></li>
                                <li><a href="javascript:;" onclick="$('#operateType').val('2')" title="通信回收">通信回收</a></li>
                ...
                <table id="t1" width="100%" cellspacing="0" cellpadding="0" class="sty-borcolor-a sty-borcolor-c com-table-b com-radius">
                    <thead>
                        <tr role="head" class="sty-bgcolor-b">
                            ...
                            <th><span class="sp sty-borcolor-b" sort="true">操作前剩余通信币（<span class="product-currencyUnit">蜂豆</span>）</span></th>
                            <th><span class="sp sty-borcolor-b" sort="true">操作后剩余通信币（<span class="product-currencyUnit">蜂豆</span>）</span></th>
                            <th>操作人</th>
                        </tr>
                    </thead>
                    <tbody>
                                    ...
                                    <tr class="${vs.count%2 eq 0 ? 'sty-bgcolor-b' : '' }">
                                        ...
                                        <td>
                                            <div class="overflow_hidden w120">
                                                ${optor.operateType==1?'通信分配':''}
                                                ${optor.operateType==2?'通信回收':''}
