...
<div id="stepBar" class="ui-stepBar-wrap">
			...
			<div class="func-menu" id="role-menu5">
			...
			<div class="role-step clearfix" id="step">
				...
				<a href="javascript:;" class="com-btnb com-btnb-sty next-step fl_l" id="step_next" style="display:none;"><label>下一步</label></a>
				<a href="javascript:;" class="com-btnb com-btnb-sty fish-secu fl_r" id="step_plte" style="display:block;"><label>完成</label></a>
			</div>
		</div>
    </div>
...
function startIntro(){
    ...
    steps: [
      {
        element: '#role-menu5',
        intro: "<p style='font-size:14px;width:165px;line-height:25px;position:absolute;left:15px;top:30px;'>每个角色的工作时间可以自由设置，设置了工作时间，该角色只能在设定的时间段拨打电话。</p><img src='${ctx}/static/images/hyx_inform.png' style='margin-left:165px;' />",
        position: 'left'
      },
      {
        element: '#step_plte',
        intro: "<p style='font-size:14px;width:165px;line-height:25px;position:absolute;left:15px;top:30px;'>请点击“完成”，结束角色管理设置。</p><img src='${ctx}/static/images/hyx_inform.png' style='margin-left:165px;' />",
        position: 'right'
      }
    ]
  });
...
$(function(){
	$(".introjs-skipbutton").live('click',function(){
		pubDivShowIframe('alert_novice_help_return','${ctx}/view/help/novice_help_com/alert_novice_help_return.jsp','角色配置指导导完成',650,350);
	});
