...
<title>新手帮助（系统管理员）-角色配置指导导完成</title>
<!--公共样式-->
...
$(function(){
    ...
    $(".bomp-nha-btna").click(function(){
    	window.parent.window.location.href = '${ctx}/main?intro=1';
	});
});
</script>
</head>
...
<div class='bomp-nha bomp-nhb bomp-nhc'>
	<p class="qut" style="text-indent:2em;">角色配置的过程已经向您演示完毕，接下来，您可以暂停系统配置引导，完成各类角色的配置，选择“开始配置”开始配置用户角色，选择“返回引导首页”继续系统配置引导。</p>
