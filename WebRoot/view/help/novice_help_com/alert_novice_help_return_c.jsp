...
<title>新手帮助（系统管理员）-目标客户分类指导完成</title>
<!--公共样式-->
...
$(function(){
    ...
    $(".bomp-nha-btna").click(function(){
    	window.parent.window.location.href = '${ctx}/main?intro=5';
	});
});
</script>
</head>
...
<div class='bomp-nha bomp-nhb bomp-nhc'>
	<p class="qut" style="text-indent:2em;">目标客户分类的过程已经向您演示完毕，接下来，您可以选择“开始配置”配置目标客户，选择“返回上一级”继续系统属性配置引导。</p>
