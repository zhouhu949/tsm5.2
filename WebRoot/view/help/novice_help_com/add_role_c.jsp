...
<div id="stepBar" class="ui-stepBar-wrap">
			...
			<div class="func-menu" id="role-menu4">
				<div class="menu-title">功能菜单</div>
				<div class="menu-cont">
					<p class="sele-canc clearfix">
						<input type="checkbox"/>
					...
					<div class="all-menu">
						...
						<p class="second-menu clearfix">
							<input type="checkbox"/>
						<span class="menu-name fl_l">系统属性</span>
						<input type="checkbox"/>
						<span class="menu-name fl_l">短信模板设置</span>
						<input type="checkbox"/>
						<span class="menu-name fl_l">系统字段</span>
						<input type="checkbox"/>
						<span class="menu-name fl_l">销售管理</span>
						</p>
						<p class="second-menu clearfix">
							<input type="checkbox"/>
						<span class="menu-name fl_l">通知公告</span>
						...
						<span class="menu-name fl_l">消息设置</span>
						<input type="checkbox"/>
						<span class="menu-name fl_l">等级成长</span>
						</p>
						<p class="first-menu clearfix">
							<input type="checkbox"/>
						<span class="fl_l">成员角色</span>
...
function startIntro(){
    ...
    steps: [
      {
        element: '#role-menu4',
        intro: "<p style='font-size:14px;width:165px;line-height:25px;position:absolute;left:15px;top:30px;'>每类角色都有自己常用的功能，接下来，就开始把常用功能设置为快捷功能吧</p><img src='${ctx}/static/images/hyx_inform.png' style='margin-left:165px;' />",
        position: 'left'
      },
      {
        element: '#step_next',
        intro: "<p style='font-size:14px;width:165px;line-height:25px;position:absolute;left:15px;top:30px;'>请点击“下一步”，进行设置工作时间操作。</p><img src='${ctx}/static/images/hyx_inform.png' style='margin-left:165px;' />",
        position: 'right'
      }
    ]
  });
...
$(function(){
	$(".introjs-skipbutton").live('click',function(){
		window.parent.window.location.href = '${ctx}/view/help/novice_help_com/add_role_d.jsp';
	})
