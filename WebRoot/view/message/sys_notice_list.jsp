...
<head>
  ...
  <%@ include file="/common/include.jsp"%>
    ...
    <script type="text/javascript">
        ...
        function getSysNoticeInfo(indexSize){
        	window.parent.pubDivShowIframe('alert_message_center_e_a','${ctx}/message/getSysNoticeInfo.do?indexSize='+indexSize,'系统消息',900,550);
        }
    </script>
...
<body>
<form action="${ctx}/message/sysNoticeList.do" id="noticeForm" method="post"/>
<div class="hyx-aspc hyx-mca hyx-mce">
    <div class="hyx-mca-top">
        <label class="lab fl_l">系统消息提醒</label>
										...
										<div class="rightbox">
											<p class="time">
												<fmt:formatDate pattern="yyyy-MM-dd HH:mm:ss"
													value="${list.sendDate}" />
										<%-- 	
												<a href="###" onclick="getSysNoticeInfo(${listv.index})"
								...
								<li class="li-load li-click"><label class="cir"></label>
									<div class="right">
										...
										<div class="rightbox">
											...
											<%--
												<a href="###"
													onclick="getSysNoticeInfo(${indexSize+historyv.index})"
													class="flow_up demoBtn_a">查看</a>
													 --%>
											</p>
											<dl class="comment">
