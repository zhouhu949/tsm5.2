...
<head>
  ...
  <%@ include file="/common/include.jsp"%>
    ...
    <script type="text/javascript">
        ...
        function getOtherNoticeInfo(indexSize){
        	window.parent.pubDivShowIframe('alert_message_center_e_a','${ctx}/message/getOtherNoticeInfo.do?indexSize='+indexSize,'其他消息',900,550);
        }
    </script>
...
<body>
<form action="${ctx}/message/otherNoticeList.do" id="noticeForm" method="post"/>
<div class="hyx-aspc hyx-mca hyx-mce">
    <div class="hyx-mca-top">
        <label class="lab fl_l">其他消息提醒</label>
										...
										<div class="rightbox">
											<p class="time">
												<fmt:formatDate pattern="yyyy-MM-dd HH:mm:ss"
													value="${list.sendDate}" />
												<c:if test="${list.msgType!=29}">
												<!-- 
													<a href="###" onclick="getOtherNoticeInfo(${listv.index})"
									...
									<div class="right">
										...
										<div class="rightbox">
											<p class="time">
									           ...
									           <c:if test="${history.msgType!=29}">
									           <!-- 
												<a href="###"
													onclick="getOtherNoticeInfo(${indexSize+historyv.index})"
													class="flow_up demoBtn_a">查看</a>
													 -->
												</c:if>
											</p>
