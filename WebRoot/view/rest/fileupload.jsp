...
<head>
    ...
    <script type="text/javascript">
        ...
        function ajaxFileUpload() {
            document.domain = "hyx.test.com";
            $.ajaxFileUpload({
                // url: ctx + '/userFile/upload',
                url: "http://up.test.com/userFile/upload",
                secureuri: false,
        ...
        function getProgress() {
            /*   var now = new Date();
             ...
             type: "post",
             dataType: "json",
             // url: ctx + "/fileStatus/upfile/progress",
             url:  "http://localhost:6060/fileStatus/upfile/progress",
             data: now.getTime(),
            ...
            $.ajax({
                async: false,
                url: "http://up.test.com/fileStatus/upfile/progress",
                dataType: "jsonp",
                jsonp: "callback",
                jsonpCallback: "flightHandler",
                success: function (data) {
