...
<form action="${ctx}/load/test" method="GET">
    <div class="hyx-cma hyx-layout">
      ...
      <div class="com-btnlist hyx-cm-btnlist fl_l">
                ...
                <a href="###" <c:if test="${shiroUser.serverDay gt 0}">onclick="toBatchSmsSend()"</c:if>
                   class="${shiroUser.serverDay gt 0 ? 'com-btna' : 'com-btna-no' } demoBtn_e fl_l">
                    <i class="min-messag ${shiroUser.serverDay gt 0 ? '' : 'img-gray' }"></i>
                ...
                <a href="${ctx}/load" id="setUnImpBtn1" class="com-btna demoBtn_g fl_l"><i class="min-cancel-prior"></i><label class="lab-mar">测试缓存</label></a>
          <a href="javascript:document.forms[0].submit();" id="setUnImpBtn2" class="com-btna demoBtn_g fl_l"><i class="min-cancel-prior"></i><label class="lab-mar">测试POST</label></a>
            </div>
