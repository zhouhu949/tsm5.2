...
<script type="text/javascript" src="${ctx}/static/js/view/res/custTransferManageData.js${_v}"></script>
...
<body>
	...
	<form id="queryForm" action="${ctx }/res/cust/custTransferManage" method="post">
		...
		<div class=" hyx-cm-left hyx-layout-content">
			<div class="com-search hyx-cm-search">
				<div class="com-search-box fl_l">
				   <div class="search clearfix" >
					   <div class="select_outerDiv fl_l">
				   		...
				   		<input class="input-query fl_l" type="text" name="queryText" value="" /><label class="hide-span"></label>
				   </div>
				   <div class="list-box">
					   <!-- 客户类型 -->
					   <input type="hidden" name="custTypeId" value="" id="s_custTypeId" />
					   <dl class="select pos${empty mutilSearchCodeSortMap['custTypeId'] ? '0' : mutilSearchCodeSortMap['custTypeId']}">
							<dt>客户类型</dt>
							<dd>
								<ul>
						...
						<dl class="select pos${empty mutilSearchCodeSortMap['startDate'] ? '0' : mutilSearchCodeSortMap['startDate']}">
							...
							<dd>
								<ul>
									...
									<li><a href="###" title="自定义" id="nDate" class="diy date-range">自定义</a></li>
								</ul>
							</dd>
						</dl>
				...
				<input class="query-button fl_r" type="button" value="高级查询"  id="superQuery" data-url="${ctx }/highSearch/toPage?module=3" data-title="高级查询" />
			...
			<div class="com-btnlist hyx-cm-btnlist fl_l">
				<a href="javascript:;" btn-type="auth" auth_id="custTransfer_custTransfer" id="transferBtn" class="com-btna demoBtn_a fl_l"><i class="min-connect"></i><label class="lab-mar">客户交接</label></a>
				<a href="javascript:;" btn-type="auth" auth_id="custTransfer_saleTransfer" id="saleTransferBtn" class="com-btna demoBtn_b fl_l"><i class="min-connect"></i><label class="lab-mar">销售交接</label></a>
