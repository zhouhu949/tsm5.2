...
<script type="text/javascript" src="${ctx}/static/js/view/res/mySilentCustData.js${_v}"></script>
...
<body>
	...
	<form id="queryForm" action="${ctx }/res/cust/mySilentCusts" method="post">
...
<!-- 					<label class="diy-day">天</label> -->
				...
				<div class="com-btnlist hyx-cm-btnlist fl_l" style="margin-top:12px;">
					<a href="javascript:;" btn-type="auth" auth_id="mySilentCust_changeToLosing" id="losingBtn" module="4" class="com-btna demoBtn_j fl_l"><label>转为流失客户</label></a>
					<a href="javascript:;" btn-type="auth" auth_id="mySilentCust_weekUp" id="weekBtn" class="com-btna demoBtn_k fl_l"><i class="min-awaken"></i><label class="lab-mar">唤醒客户</label></a>
				</div>
