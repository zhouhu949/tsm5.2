...
<form action="${ctx}/res/cust/saveDetail" method="post" id="myForm">
    <div class='bomp-cen bomp_change bomp-mcl project-comp-idialog-box  <c:if test="${dayPlanflag eq 1 }">daily-planedit-cust-box</c:if>'>
        ...
        <input type="hidden" name='idReplaceWord' id='idReplaceWord' value='${idReplaceWord}'>
            <div class="check fl_r"><input type='checkbox' name="mainLink"
                                           class='fl_l' ${!empty detailList?'':'checked disabled' }
                                           id="mainLink"/><label class='fl_l font-s'>主要联系人</label></div>
        </div>
                        ...
                        <p class='bomp-p' id="bomp_error_${field.fieldCode }">
                            <label class='lab_a fl_l'>
                                <c:choose>
                                    ...
                                    ${field.fieldName}：
                            </label><input type='text' id="${field.fieldCode }" name="${field.fieldCode }" value=''
                                           checkDetailProp="${field.isRequired eq 0?'chk_1_0':'chk_1_1' }"
                                           class='ipt_a fl_l'/>
                    ...
                    <c:when test="${'telphone' eq field.fieldCode && field.enable eq 1  }">
                        <p class='bomp-p p_relative' id="bomp_error_${field.fieldCode }">
                            ...
                            <input type='text' id="${field.fieldCode }_safe" name="${field.fieldCode }_safe"
                                   ...
                                   checkDetailProp="${field.isRequired eq 0?'chk_1_0':'chk_1_1' }" class='ipt_a fl_l'/>
                    ...
                    <c:when test="${'sex' eq field.fieldCode && field.enable eq 1  }">
                        <p class='bomp-p' id="bomp_error_${field.fieldCode }">
                            ...
                            <select class='sel_a fl_l' id="${field.fieldCode }" name="${field.fieldCode }"
                                    value='${detail.sex }' checkDetailProp="${field.isRequired eq 0?'':'chk_2_1' }">
                        ...
                        <p class='bomp-p' id="bomp_error_${field.fieldCode }">
                            <label class='lab_a fl_l'>
                                <c:choose>
                                    ...
                                    ${field.fieldName}：</label><input type='text' id="${field.fieldCode }"
                                                                      name="${field.fieldCode }"
                                                                      value='${detail.email }'
                                                                      checkDetailProp="${field.isRequired eq 0?'chk_1_0':'chk_1_1' }"
                                                                      class='ipt_a fl_l'/>
                        ...
                        <p class='bomp-p' id="bomp_error_${field.fieldCode }">
                            <label class='lab_a fl_l'>
                                <c:choose>
                                    ...
                                    ${field.fieldName}：</label><input type='text' id="${field.fieldCode }"
                                                                      name="${field.fieldCode }" value='${detail.fax }'
                                                                      checkDetailProp="${field.isRequired eq 0?'chk_1_0':'chk_1_1' }"
                                                                      class='ipt_a fl_l'/>
                            <span class="error" id="error_${ field.fieldCode}"></span>
                        </p>
                        ...
                        <p class='bomp-p' id="bomp_error_${field.fieldCode }">
                            <label class='lab_a fl_l'>
                                <c:choose>
                                    ...
                                    ${field.fieldName}：</label><input type='text' id="${field.fieldCode }"
                                                                      name="${field.fieldCode }" value='${detail.qq }'
                                                                      checkDetailProp="${field.isRequired eq 0?'':'chk_1_1' }"
                                                                      class='ipt_a fl_l'/>
                            <span class="error" id="error_${ field.fieldCode}"></span>
                        </p>
                    </c:when>
                        ...
                        <p class='bomp-p' id="bomp_error_${field.fieldCode }">
                            <label class='lab_a fl_l'>
                                <c:choose>
                                    ...
                                    ${field.fieldName}：</label><input type='text' id="${field.fieldCode }"
                                                                      name="${field.fieldCode }" value='${detail.work }'
                                                                      checkDetailProp="${field.isRequired eq 0?'':'chk_1_1' }"
                                                                      class='ipt_a fl_l'/>
                            <span class="error" id="error_${ field.fieldCode}"></span>
                        </p>
