	     ...
	     <c:forEach items="${fieldSets}" var="field" varStatus="vs"> 
							     ...
							     <c:choose>
							          ...
							          <c:when test="${'birthday' eq field.fieldCode && field.enable eq 1}">
											<p class='bomp-p' id="bomp_error_${field.fieldCode }">
														   	<label class='lab_a fl_l'>
														    	...
														    	${field.fieldName}：
														   	</label><input type='text'   onclick="WdatePicker({maxDate:'%y-%M-%d'})"   id="${field.fieldCode }"  name="custInfo.${field.fieldCode }" value='' checkProp="${field.isRequired eq 0?'':'chk_5_1' }" class='ipt_a fl_l' />
											    <span  class="error" name='a'  id="error_${ field.fieldCode}"></span>
											</p>				          
							          </c:when>							     
						             ...
						             <c:when test="${'mobilephone' eq field.fieldCode && field.enable eq 1  }">
											<p class='bomp-p p_relative' id="bomp_error_${field.fieldCode }">
														   	...
														   	<input type='hidden' id="${field.fieldCode }"  name="custInfo.${field.fieldCode }"  value='${phone }' checkProp="${field.isRequired eq 0?'chk_1_0':'chk_1_1' }"  class='ipt_a fl_l' />
														   	<span class="min-dele delete_telno" title="清除"  onclick="clearPhone('mobilephone','mobilephone_safe','error_dp')"></span>
														   	<input type='text'   id="${field.fieldCode }_safe"  name="custInfo.${field.fieldCode }_safe"  value='${phone }' checkProp="${field.isRequired eq 0?'chk_1_0':'chk_1_1' }"  class='ipt_a fl_l' />
												<span  class="error" name='a'  id="error_${ field.fieldCode}"></span>
											</p>		             
						             </c:when>
						             ...
						             <c:when test="${'alternatePhone2' eq field.fieldCode && field.enable eq 1  }">
											<p class='bomp-p' id="bomp_error_${field.fieldCode }">
														   	...
														   	<input type='text'   id="${field.fieldCode }"  name="custInfo.${field.fieldCode }"  checkProp="${field.isRequired eq 0?'chk_1_0':'chk_1_1' }"  class='ipt_a fl_l' />
												<span  class="error" name='a'  id="error_${ field.fieldCode}"></span>
											</p>		             
						             </c:when>						             
			                          ...
			                          <c:when test="${'companyOrg' eq  field.fieldCode  && field.enable eq 1}">
											<p class='bomp-p' id="bomp_error_${field.fieldCode }">
														   	<label class='lab_a fl_l'>
														    	...
														    	${field.fieldName}：
														   	</label><input type='text' value=''  id="${field.fieldCode }"  name="custInfo.${field.fieldCode }" checkProp="${field.isRequired eq 0?'':'chk_1_1' }"class='ipt_a fl_l' />
												 <span  class="error" name='a'  id="error_${ field.fieldCode}"></span>
											</p>                          
			                          </c:when>
			...
			<div class='bomb-btn bomb-btn-top bomb-btn-change'>
					<label class='bomb-btn-cen'>
						<a href="###" id="addCustByScreen" class="com-btna bomp-btna sure-btn com-btna-sty fl_l"><label>下一步</label></a>
					</label>
			</div>
	   </div>
	</form>
