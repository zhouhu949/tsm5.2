...
<html>
	...
	<body>
		...
		<input type="hidden" id="timeElngth" value="${timeElngth}" />
		...
		<input type="hidden" id="tempResId" name="tempResId" value="0" />	
	...
	<div class="taoCust_left hyx-layout-content">
			<div class="card fl_l">
				<p class="p_a">
					...
					<shiro:hasPermission name="base_custEdit">
			...
			<div class="card_operate fl_r">
				<div class="card_operate_head">
					<div class="operate_head_left">拨通次数：<span id="list_callnum"></span>次</div>
					<div class="operate_head_right" id="todayDateId">
						<i class="icon-today-data" title="今日数据"></i> 个人今日数据
					</div>
				</div>

				<div class="card_operate_content_p border-right">
				...
				<div class="card_operate_content_p card_operate_content_second border-left border-right">
					<div class="operate_content_area">
				...
				<div class="card_operate_content_table_p border-left">
			...
			<div class="operate_button fl_r">
				<div class="hyx-sce-left-btn fl_l">
					...
					<div class="drop-box drop-box-b fl_r">
						<button id="dealType_4" type="button" class="com-btna fl_r com-btna-no">沟通失败</button>
					...
					<div class="drop-box drop-box-b fl_r">
						<button id="dealType_5" type="button" class="com-btna fl_r com-btna-no">信息错误</button>
						<span class="drop" style="display:none;">
							<label class="arrow"><em>◆</em><span>◆</span></label>
							<label class="box"></label>
						</span>
			...
			<form action="${ctx}/res/tao/addMyCust" id="taoForm" method="post">
			    ...
			    <input type="hidden" id="opterType" name="opterType" value="1" />
						...
						<div class="sales_info_detail">
							<div class="sales_info_detail_input">
								...
								<div class='bomp-p bomp-p-w contact_note'>
									...
									<label class="hyx-sce-area">
										<textarea id="feedbackComment" name="feedbackComment" maxlength="4000" checkProp="chk_1_1" class='area_a fl_l' placeholder="请输入与客户联系结果，最多可输入2000个汉字"></textarea>
			                    ...
			                    <div class="bomp-box">
									...
									<p class='bomp-p'>
										...
										<input type="text"  name="followDate"  id="followDate" class="ipt"  <c:if test="${nextFollowValidation eq 1 }">checkProp="chk_1_1"</c:if> data-next="${nextFollowValidation }" />
										<span class="error"></span>
									</p>
								</div>
								...
								<div class="sty-hid fl_l">
									<div class="bomp-box">
										<p class='bomp-p'>
											...
											<input type="text"  class="ipt" value="" name="expectDate" id="expectDate"   onclick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss'})" class="ipt" />
										</p>
										<p class='bomp-p'>
											<label class='lab_a fl_l'>预期销售额：</label>
											<input type="text"  value="" class="ipt" name="expectSale" id="expectSale" checkProp="chk_1_01"/>
										</p>
									</div>
									<p class='bomp-p bomp-p-w'>
										<label class='lab_a fl_l'>销售对策：</label>
										<input type="text" value="" class="ipt bomp-ipt-w" name="saleWay"  id="saleWay"/>
									</p>
									<p class='bomp-p bomp-p-w'>
										<label class='lab_a fl_l'>客户异议：</label>
										<input type="text" value="" class="ipt bomp-ipt-w" name="custArgue" id="custArgue"/>
									</p>
									<p class='bomp-p bomp-p-w'>
										<label class='lab_a fl_l'>客户兴趣：</label>
										<input type="text" value="" class="ipt bomp-ipt-w" name="custInterest" id="custInterest"/>
									</p>
									<p class='bomp-p bomp-p-w'>
										<label class='lab_a fl_l'>竞争对手：</label>
										<input type="text" value="" class="ipt bomp-ipt-w" name="competitor" id="competitor"/>
									</p>
									<div class='bomp-p bomp-p-w'>
										<label class='lab_a fl_l'>备注：</label>
										<label class="hyx-sce-area">
											<textarea class='area_a fl_l' name="remark" maxlength="400"  id="remark" placeholder="最多可输入200个汉字"></textarea>
											<!-- <span class="textarea_tip">最多可输入200个汉字。</span> -->
										</label>
									</div>
								</div>
							<!--  
								<i class="icon_down icon_down_a fl_l icon_more_info" name="down"></i>
								-->
							</div>
							<div class="sales_info_detail_button">
								<div class="com-btnbox hyx-sce-left-btnbox">
									...
									<shiro:hasPermission name="base_signCust">
									<a href="###" id="signCustId" class="com-btnb fl_r"><label>签&nbsp;&nbsp;约</label></a>
					  				</shiro:hasPermission>
...
<%-- 							<img id="freshCache" src="${ctx}/static/images/Share_change.png"> --%>
									...
									<table width="100%" cellspacing="0" cellpadding="0" class="sty-borcolor-a sty-borcolor-c com-table-b com-radius">
										<thead>
											<tr class="sty-bgcolor-b">
												...
												<th style="border: 1px solid #e6e6e6; border-right: none;border-left: none;" class="th_dyMobile">联系电话</th>
											</tr>	
										</thead>
										<tbody>
        ...
        <script type="text/javascript" src="${ctx}/static/thirdparty/jquery/jquery.form.js${_v}${_v}"></script>
