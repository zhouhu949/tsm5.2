			...
			<tbody>
				...
				<c:when test="${!empty list}">
					...
					<tr class="${i.index%2!=0?'sty-bgcolor-b':''}">
						...
						<td><div class="overflow_hidden w70" title="${bean.resSignNum }">${bean.resSignNum }</div></td>
						<td><div class="overflow_hidden w70" title="${bean.resCustNum }">${bean.resCustNum }</div></td>
