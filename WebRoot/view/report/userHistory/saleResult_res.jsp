...
<title>销售统计-个人历史数据-销售结果统计-资源</title>
<!--本页面样式-->
...
<div class="sales-statis-conta">
	<div class="bomp_ic_tip">
		<ul class="list">
			<li class="li_click" _url="${ctx}/report/userStatis/saleResult?pageType=res" >资源联系结果</li>
			<li _url="${ctx}/report/userStatis/saleResult?pageType=will">意向联系结果</li>
		</ul>
	</div>
						...
						<td><div class="overflow_hidden w70" title="${bean.resSignNum }">
						 <c:choose>
				                	<c:when test="${bean.resSignNum > 0 }">
				                		<a class="view_change" href="javascript:;" date="${bean.reportDateStr}" cust_type="1" change_type="2">${bean.resSignNum }</a>
				                	</c:when>
				                ...
				                <td><div class="overflow_hidden w70" title="${bean.resCustNum }">
								 <c:choose>
				                	<c:when test="${bean.resCustNum > 0 }">
				                		<a class="view_change" href="javascript:;" date="${bean.reportDateStr}"  cust_type="1" change_type="1">${bean.resCustNum }</a>
				                	</c:when>
