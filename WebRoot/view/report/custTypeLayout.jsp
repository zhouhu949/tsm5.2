...
<head>
    ...
    <title>销售统计-团队客户分布-客户类型分布详情</title>
	<style type="text/css">
	...
	<script type="text/javascript">
		...
		function loadAccountLayout(groupId,optionlistIds){
			$.post(ctx+"/layout/team/custTypeReport/member",{groupId:groupId,optionlistIds:optionlistIds},function(data){
				$("#userDiv").html(data);
				$.parser.parse();
...
<body>
<form action="${ctx }/layout/team/custTypeReport" method="post">
<div class="person-static-max">
	<div class="hyx-silent-p clearfix" style="z-index:555;">
		...
		<div class="com-search-report fl_l" style="margin-top:-4px;min-height:0">
			<label class="fl_l" for="" style="line-height:34px;">客户类型：</label>
	...
	<p class="hyx-mpe-ptit"><label class="com-red">温馨提示：</label>“/”前面的值表示该客户类型的数据量，“/”后面的值表示该客户类型的数量占总量的占比。</p>
</div>
</form>
</body>
</html>