	...
	<body>
			...
			<div class="com-table com-mta hyx-cla-table">
	            <table id="t1" width="100%" cellspacing="0" cellpadding="0" class="sty-borcolor-a sty-borcolor-c com-table-b com-radius ajax-table">
	                ...
	                <tr role="head" class="sty-bgcolor-b">
	                    ...
	                    <th><span class="sp sty-borcolor-b">${history?'本':'今'}日初始销售进程</span></th>
	                    <th><span class="sp sty-borcolor-b">${history?'本日结束':'本次'}销售进程</span></th>
		...
		<script type="text/x-handlebars-template" id="template">
			...
			<tr class="{{even_odd @index}}">
				...
				<td>
					<div class="overflow_hidden w100" title="{{initSaleProcessName }}">{{initSaleProcessName }}</div>
				</td>
				<td>
					<div class="overflow_hidden w80" title="{{saleProcessName }}">{{saleProcessName }}</div>
				</td>
				<td>
