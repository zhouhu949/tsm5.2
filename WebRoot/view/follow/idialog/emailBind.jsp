...
<div class='bomp-cen'>
	<form id="myForm">
		<div class="bomp-tip-a" style="margin-top:20px;"><label class="tip-b fl_l" style="margin-left:45px;margin-right:10px;"></label><span class="sp-a fl_l" style="font-size:12px;">首次使用邮件功能，需绑定邮箱</span></div>
