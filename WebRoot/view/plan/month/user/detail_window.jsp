...
<div class='bomp-cen bomp-mtesa'>
	...
	<div class="com-table hyx-mpe-table" style="overflow:hidden;">
		<table cellspacing="0" cellpadding="0" class="sty-borcolor-a sty-borcolor-c com-table-a">
			<thead>
				...
				<c:when test="${dto!=null and !empty dto.custs}">
					<c:forEach items="${dto.custs}" var="cust" varStatus="i">
						...
						<c:if test="${i.index%2==0}"><tr></c:if>
							...
							<td><div name="singcustNum" class="overflow_hidden w80" title="${cust.singcustNum==0?'签约客户':'意向客户' }">${cust.singcustNum==0?'签约客户':'意向客户' }</div></td>
