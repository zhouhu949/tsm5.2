   ...
   <div class="com-search hyx-cfu-search">
      ...
      <div class="search clearfix" >
		   ...
		   <span class="icon_down_5px"></span>
		    ...
		    <option value = "3"  <c:if test="${queryType eq 3}">selected</c:if>>单位名称</option>
	   		<option value = "1"  <c:if test="${queryType eq 1}">selected</c:if>>客户姓名</option>
	   		<option value = "2"  <c:if test="${queryType ne 1 and queryType ne 3 }">selected</c:if>>联系号码</option>
	   		</select>
		   	</div>
