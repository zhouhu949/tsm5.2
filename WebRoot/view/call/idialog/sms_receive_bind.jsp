...
<div class='bomp-cen' style="margin-top:30px;">
	<form id="myForm">
		<div class='bomp-p w-a bomp-linewidth'>
			<label class='lab_a fl_l'>手机号码：</label><input type='text' name="mobile" id="mobile" value="${mobile}" class='ipt_a fl_l ipt_mobile'  placeholder="请输入手机号"/>
		</div>
