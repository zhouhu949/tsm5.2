...
<html>
	...
	<!-- 载入播放器资源文件 -->
	<link href="${ctx}/static/js/jPlayer/skin/blue.monday/jplayer.blue.monday.css${_v}" rel="stylesheet" type="text/css" />
	<style type="text/css"> 
      body{font-size:12px;}
      img{border:0;}
      ...
      .player_all_lineheight01{width:16px;height:13px;margin-top:-15px;margin-left:240px !important;*margin-top:-35px;*margin-left:180px !important;margin-right:6px;background:url(${ctx}/static/js/jPlayer/images/player_all01.png) no-repeat;}
      ...
      .lelistplayer_tab tr td{height:30px;line-height:30px;border:0;border-bottom:1px solid #eee;padding:5px;white-space:nowrap;}
      			...
      			<div class="player_right">
					...
					<div class="jp-type-single">
      				<div class="jp-gui jp-interface">
						...
						<li> <a href="###" class="player_up"  id="last_play"></a></li>
						<li><a href="###" class="jp-pause" tabindex="1" >暂停</a></li>		
						<li><a href="###" class="player_down"  id="next_play"></a></li>
						<span class="player_customer" id="scroll"></span>
						<a href="###" class="player_all_lineheight01"  title="取消播放全部" id="palys"></a>
						<a href="###" class="player_deletelist" id="clearAll" title="清空"></a>
						</ul>												
      			...
      			<div class="player_right">
					...
					<div class="jp-type-single">
      				<div class="jp-gui jp-interface">
						...
						<li><a href="###" class="player_down"  id="next_play"></a></li>
						<span class="player_customer" id="scroll"></span>
						<a href="###" class="player_all_lineheight"  title="取消播放全部" id="palys"></a> 
						<a href="###" class="player_deletelist" id="clearAll" title="清空"></a>
						</ul>												
					<div class="jp-progress">
						<div class="jp-seek-bar">
        		...
        		<table class="lelistplayer_tab"cellspacing="0" cellpadding="0" id="list">
        			 ...
        			 <c:forEach items="${callList}" var="call" varStatus="v">       					             
		              <tr callName="<c:out value="${call.custName}"/>" >  
		                    ...
		                    <td  id="cnm_${index}" style="width:90px; color:#909090" title="${call.custName}">${call.custName}&nbsp;${call.calledNum}</td>	                  
		                    ...
		                    <td style="width:60px;">
		                    <a href="###" name="play" v="${index}"  id="playing_${index}"  class="player_nochoose01" title="录音播放"></a>
		                    <a href="###"  id="del_playing_${index}"  class="player_nochoose02" name="deletePlay" playId="${call.callId}" title="删除" ></a>
...
<script type="text/javascript" src="${ctx}/static/js/jPlayer/js/jquery.jplayer.min.js${_v}"></script>
...
// 播放全部按钮 切换
 $("#palys").toggle(function(){
	...
	$("[name='deletePlay']").click(function(){
		...
		// 弹窗确认
		queDivDialog("res_remove_cust","确定要删除吗？",function(){
	...
	$("#clearAll").click(function(){
		// 弹窗确认
		 queDivDialog("res_remove_cust","确定要清空吗？",function(){
				$.ajax({
