	...
	<script type="text/javascript">
     $(function(){
		 ...
		 $("#cancletBtn").click(function(){
			 parent.closePubDivDialogIframe("addKnowlege");
		 });
     })
           ...
           <form method="post" action="${ctx}/sys/knowlege/saveOrUpdate" id="myForm" name="myForm">
			   ...
			   <div class="com-search clearfix" style="min-height:30px;">
				...
				<div class="new-words-title">
					<label for="">标题：</label><input type="text"  id="question" name="question">
				</div>
				<div class="new-words-cont">
					<textarea id="editor" name="editor" id="" cols="30" rows="10"></textarea>
				</div>
				</div>
				<div class="bomb-btn" style="margin-top:20px">
						<label class="bomb-btn-cen">
							<a class="com-btna bomp-btna com-btna-sty sure-btn fl_l" href="###" id="savebutton"><label>保存</label></a>
							<a class="com-btna bomp-btna cancel-btn fl_l" href="###" id="cancletBtn" ><label>取消</label></a>
						</label>
				</div>
</form>
</body>
