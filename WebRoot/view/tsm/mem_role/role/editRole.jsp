...
<!--本页面js-->
<script type="text/javascript" src="${ctx}/static/js/stepbar/js/jquery.easing.1.3.js"></script><!--步骤-->
<script type="text/javascript" src="${ctx}/static/js/stepbar/js/stepbar.js"></script><!--步骤-->
<style type="text/css">
	.tree-node{width: 370px;}
	.tree-title{width:300px;}
	.ui-stepBar-wrap .ui-stepInfo-wrap .ui-stepInfo .ui-stepSequence{padding:5px 10px;}
...
<div class="">
	<div class="hyx-hsm-left fl_l">		
		<dl>
			<dt>角色列表</dt>
			<p class="add-role" style="text-indent:30px;text-align:left;"><a class="add-role-new"  onclick="jump_add();" href="javascript:;"><span>创建角色</span><img src="${ctx }/static/images/add-role.png" alt=""></a></p> 
			<c:forEach items="${roles}" var="role">
				<dd class="${role.roleId eq roleId?'dd-hover senior-manag clearfix':''}"  title="${role.roleName }"><span class="fl_l">${role.roleName }</span>
	...
	<div class="hyx-oral-right-title"><span>修改角色</span><div style="float:right;"><button class="hyx-right-title-btn stitle-btn-save" onclick="complete_()">保存</button></div></div>
			...
			<div class="role-edit-info" id="role-menu1">				  				  	
					    ...
					    <div class="addRoleTitle"><div class="xiaoduanshu"></div>编辑角色名称</div>
