...
<div class="hyx-spsa clearfix">
	<div class="com-btnlist hyx-sps-btnlist fl_l">
		<%-- <a href="javascript:;" class="com-btna alert_sys_pro_set_b_a fl_l" data-total="${item.page.totalResult}" onclick="add_('${item.itemCode }');"><i class="min-new-add"></i><label class="lab-mar">新&nbsp;&nbsp;&nbsp;&nbsp;增</label></a>
		...
		<button type="button" class="button-mid property-add" data-itemCode="${item.itemCode}" id="add_"><i class="min-new-add"></i>新&nbsp;&nbsp;&nbsp;&nbsp;增</button>
				 	...
				 	<c:when test="${!empty optionList}">
				 		<c:forEach items="${optionList }" var="option" varStatus="v">
				 			<tr class="${v.count%2==0?'sty-bgcolor-b':''}">
								...
								<td style="width:70px;"><div class="overflow_hidden w70 link"><a href="javascript:;" class="icon-edit alert_sys_pro_set_b_b" onclick="update_('${option.optionlistId}')"  title="编辑" ></a></div></td>
