...
<body>
<form action="${ctx}/custField/com/custFieldComPage.do" >
<div class="hyx-sfs com-table-a hyx-mpe-table hyx-cm-table fl_l" style="overflow-x:hidden;">
	<div class="year-sale-play hyx-hsrs-top">
		<ul class="ann-sale-plan clearfix">
			<a href="${ctx }/custField/com/custFieldComPage.do"><li class="select li_first">企业字段</li></a>
			<a href="${ctx }/custField/contacts/custFieldContactsPage.do"><li class="li_last">联系人字段</li></a>
		</ul>
	</div>
	<dl class="tit">
		<dt class="com-red"><h2>温馨提示：</h2></dt>
		<dd>1.点击操作列“上移”、“下移”可以对字段进行排序，客户名称字段不能被重新排序；</dd>
	...
	<p class="hyx-mpe-p" style="margin-left:1%;">
		...
		<a href="###" class="com-red fl_r demoBtn_a" data-sure-url="${ctx}/custField/com/getIdFinedCount.do" data-url="${ctx }/custField/com/reditPage.do" data-count="18">+添加自定义字段</a>
		<button type="button" class="btn btn-md btn-submit" style="float: right; margin-right: 10px;" data-url="${ctx }/custField/com/modfiy">保存</button>
	</p>
...
{{#each list}}
	<tr class="{{even_odd @index}}">
		...
		<td>{{systemFieldOperateBtn "custFieldCom" fieldId sort "/custField/com/reditPage.do"}}</td>
		<td>{{fieldName}}</td>
